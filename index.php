    ...
    <section class="featured">
        <div class="container featured__container">
            ...
            <div class="post__info">
                <?php
                //fetch category from categories table using category_id in posts table
                $category_id = $featured['category_id'];
                $category_query = "SELECT * FROM categories WHERE id=$category_id";
                $category_result = mysqli_query($connection, $category_query);
                $category = mysqli_fetch_assoc($category_result);
                ?>
                <a href="<?= ROOT_URL ?>category_post.php?id=<?= $featured['category_id']?>" class="category__button"><?= $category['title'] ?></a>
    ...
    <section class="posts <?= $featured ? '' : 'section__extra-margin'?>">
        <div class="container posts__container">
            ...
            <article class="post">
                ...
                $category = mysqli_fetch_assoc($category_result);
                ?>
                    <a href="<?= ROOT_URL ?>category_post.php?=<?= $post['category_id']?>" class="category__button"><?= $category['title']?></a>
